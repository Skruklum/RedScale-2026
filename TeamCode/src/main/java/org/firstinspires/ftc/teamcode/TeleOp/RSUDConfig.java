...
@TeleOp
@Config
public class RSUDConfig extends LinearOpMode {
    ...
    static double HD_HEX_TICKS_PER_REV = 28.0;
    static double TURRET_GEAR_RATIO = 4.75;
    static double CORE_HEX_TICKS_PER_REV = 288.0 * TURRET_GEAR_RATIO;

    // Shooter Constants
    public static double TARGET_RPM = 3000.0;
    static double SHOOTER_TICKS_PER_SEC = (TARGET_RPM / 60.0) * HD_HEX_TICKS_PER_REV;

    static double TURRET_KP = 0.02;
    static double TURRET_MAX_POWER = 0.6;
    static double TURRET_LIMIT_DEG = 60.0;
    static int TURRET_LIMIT_TICKS = (int) ((TURRET_LIMIT_DEG / 360.0) * CORE_HEX_TICKS_PER_REV);
