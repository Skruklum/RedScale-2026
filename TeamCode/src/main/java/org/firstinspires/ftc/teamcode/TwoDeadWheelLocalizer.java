...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -5952.674327952829; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1570.0433393634835; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
        ...
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "front_right_drive"))); //HORIZONTAL
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "front_left_drive"))); //VERTICAL
