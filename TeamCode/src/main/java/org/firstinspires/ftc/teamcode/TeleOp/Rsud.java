...
@TeleOp(name = "RSUD Turret Auto Aim (No Deadband)", group = "Testing")
public class Rsud extends LinearOpMode {
    ...
    // Turret gear ratio
    static final double TURRET_GEAR_RATIO = 239.0 / 25.0; // 9.56:1
    ...
    public void runOpMode() {
        ...
        // Fix Exposure: 6ms exposure, 250 gain
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                if (gamepad2.dpad_right) {
                    stopperS.setPower(1.0);
                } else if (gamepad2.dpad_left) {
                    stopperS.setPower(-1.0);
                } else {
                    stopperS.setPower(0.0);
                }
                ...
                telemetry.addLine("===== RSUD TURRET (NO DEADBAND) =====");
    ...
    private void updateCameraLogic() {
        ...
        // DEADBAND REMOVED: Always correcting
